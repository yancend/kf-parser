...
class Kiss
{
    ...
    public function print_js(  $cov)
    {
        ...
        print "<script type='text/javascript' src='../../dev-lib/kitygraph.all.js' ></script>\n";
        print "<script type='text/javascript' src='../../dev-lib/kity-formula.all.js' ></script>\n";
        print "<script type='text/javascript' src='../../dist/kityformula-parser.all.js' ></script>\n";
